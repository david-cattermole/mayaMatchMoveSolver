...
make distclean
make library -j4 AUTOCC=no MKLROOT=/opt/intel/mkl/ BLAS='-L/opt/intel/mkl/lib/intel64 -Wl,--no-as-needed -lmkl_intel_lp64 -lmkl_core -lmkl_gnu_thread -lgomp -lpthread -lm -ldl' LAPACK=''
cd ../../../
