...
struct ShimImagePixelDataRgbaF32 final : public ::rust::Opaque {
  ...
  MMIMAGE_API_EXPORT ::rust::Slice<const ::mmimage::PixelRgbaF32> data() const noexcept;
  MMIMAGE_API_EXPORT ::rust::Slice<::mmimage::PixelRgbaF32> data_mut() noexcept;
...
struct ShimImagePixelData2DF64 final : public ::rust::Opaque {
  MMIMAGE_API_EXPORT ::std::size_t width() const noexcept;
  MMIMAGE_API_EXPORT ::std::size_t height() const noexcept;
  MMIMAGE_API_EXPORT ::rust::Slice<const ::mmimage::Pixel2DF64> data() const noexcept;
...
bool mmimage$cxxbridge1$PixelRgbaF32$operator$eq(const PixelRgbaF32 &, const PixelRgbaF32 &) noexcept;
bool mmimage$cxxbridge1$PixelRgbaF32$operator$ne(const PixelRgbaF32 &, const PixelRgbaF32 &) noexcept;
bool mmimage$cxxbridge1$PixelRgbaF32$operator$lt(const PixelRgbaF32 &, const PixelRgbaF32 &) noexcept;
bool mmimage$cxxbridge1$PixelRgbaF32$operator$le(const PixelRgbaF32 &, const PixelRgbaF32 &) noexcept;
bool mmimage$cxxbridge1$PixelRgbaF32$operator$gt(const PixelRgbaF32 &, const PixelRgbaF32 &) noexcept;
bool mmimage$cxxbridge1$PixelRgbaF32$operator$ge(const PixelRgbaF32 &, const PixelRgbaF32 &) noexcept;
bool mmimage$cxxbridge1$Pixel2DF64$operator$eq(const Pixel2DF64 &, const Pixel2DF64 &) noexcept;
bool mmimage$cxxbridge1$Pixel2DF64$operator$ne(const Pixel2DF64 &, const Pixel2DF64 &) noexcept;
bool mmimage$cxxbridge1$Pixel2DF64$operator$lt(const Pixel2DF64 &, const Pixel2DF64 &) noexcept;
bool mmimage$cxxbridge1$Pixel2DF64$operator$le(const Pixel2DF64 &, const Pixel2DF64 &) noexcept;
bool mmimage$cxxbridge1$Pixel2DF64$operator$gt(const Pixel2DF64 &, const Pixel2DF64 &) noexcept;
bool mmimage$cxxbridge1$Pixel2DF64$operator$ge(const Pixel2DF64 &, const Pixel2DF64 &) noexcept;
::std::size_t mmimage$cxxbridge1$ShimImagePixelDataRgbaF32$operator$sizeof() noexcept;
::std::size_t mmimage$cxxbridge1$ShimImagePixelDataRgbaF32$operator$alignof() noexcept;

::std::size_t mmimage$cxxbridge1$ShimImagePixelDataRgbaF32$width(const ::mmimage::ShimImagePixelDataRgbaF32 &self) noexcept;

::std::size_t mmimage$cxxbridge1$ShimImagePixelDataRgbaF32$height(const ::mmimage::ShimImagePixelDataRgbaF32 &self) noexcept;

::rust::repr::Fat mmimage$cxxbridge1$ShimImagePixelDataRgbaF32$data(const ::mmimage::ShimImagePixelDataRgbaF32 &self) noexcept;

::rust::repr::Fat mmimage$cxxbridge1$ShimImagePixelDataRgbaF32$data_mut(::mmimage::ShimImagePixelDataRgbaF32 &self) noexcept;

::mmimage::ShimImagePixelDataRgbaF32 *mmimage$cxxbridge1$shim_create_image_pixel_data_rgba_f32_box() noexcept;
::std::size_t mmimage$cxxbridge1$ShimImagePixelData2DF64$operator$sizeof() noexcept;
::std::size_t mmimage$cxxbridge1$ShimImagePixelData2DF64$operator$alignof() noexcept;

::std::size_t mmimage$cxxbridge1$ShimImagePixelData2DF64$width(const ::mmimage::ShimImagePixelData2DF64 &self) noexcept;

::std::size_t mmimage$cxxbridge1$ShimImagePixelData2DF64$height(const ::mmimage::ShimImagePixelData2DF64 &self) noexcept;

::rust::repr::Fat mmimage$cxxbridge1$ShimImagePixelData2DF64$data(const ::mmimage::ShimImagePixelData2DF64 &self) noexcept;

::rust::repr::Fat mmimage$cxxbridge1$ShimImagePixelData2DF64$data_mut(::mmimage::ShimImagePixelData2DF64 &self) noexcept;

::mmimage::ShimImagePixelData2DF64 *mmimage$cxxbridge1$shim_create_image_pixel_data_2d_f64_box() noexcept;
...
void mmimage$cxxbridge1$shim_create_image_rgba_f32(::std::size_t image_width, ::std::size_t image_height, ::rust::Box<::mmimage::ShimImagePixelDataRgbaF32> &out_pixel_data) noexcept;

void mmimage$cxxbridge1$shim_create_image_2d_f64(::std::size_t image_width, ::std::size_t image_height, ::rust::Box<::mmimage::ShimImagePixelData2DF64> &out_pixel_data) noexcept;

bool mmimage$cxxbridge1$shim_image_read_pixels_exr_rgba_f32(::rust::Str file_path, ::rust::Box<::mmimage::ShimImageMetaData> &out_meta_data, ::rust::Box<::mmimage::ShimImagePixelDataRgbaF32> &out_pixel_data) noexcept;
...
bool mmimage$cxxbridge1$shim_image_write_pixels_exr_rgba_f32(::rust::Str file_path, ::mmimage::ImageExrEncoder exr_encoder, const ::rust::Box<::mmimage::ShimImageMetaData> &in_meta_data, const ::rust::Box<::mmimage::ShimImagePixelDataRgbaF32> &in_pixel_data) noexcept;
} // extern "C"
} // namespace mmimage
...
MMIMAGE_API_EXPORT ::std::size_t ShimImagePixelDataRgbaF32::width() const noexcept {
  return mmimage$cxxbridge1$ShimImagePixelDataRgbaF32$width(*this);
}

MMIMAGE_API_EXPORT ::std::size_t ShimImagePixelDataRgbaF32::height() const noexcept {
  return mmimage$cxxbridge1$ShimImagePixelDataRgbaF32$height(*this);
}

MMIMAGE_API_EXPORT ::rust::Slice<const ::mmimage::PixelRgbaF32> ShimImagePixelDataRgbaF32::data() const noexcept {
  return ::rust::impl<::rust::Slice<const ::mmimage::PixelRgbaF32>>::slice(mmimage$cxxbridge1$ShimImagePixelDataRgbaF32$data(*this));
}

MMIMAGE_API_EXPORT ::rust::Slice<::mmimage::PixelRgbaF32> ShimImagePixelDataRgbaF32::data_mut() noexcept {
  return ::rust::impl<::rust::Slice<::mmimage::PixelRgbaF32>>::slice(mmimage$cxxbridge1$ShimImagePixelDataRgbaF32$data_mut(*this));
}

MMIMAGE_API_EXPORT ::rust::Box<::mmimage::ShimImagePixelDataRgbaF32> shim_create_image_pixel_data_rgba_f32_box() noexcept {
  return ::rust::Box<::mmimage::ShimImagePixelDataRgbaF32>::from_raw(mmimage$cxxbridge1$shim_create_image_pixel_data_rgba_f32_box());
}
...
MMIMAGE_API_EXPORT ::std::size_t ShimImagePixelData2DF64::width() const noexcept {
  return mmimage$cxxbridge1$ShimImagePixelData2DF64$width(*this);
}

MMIMAGE_API_EXPORT ::std::size_t ShimImagePixelData2DF64::height() const noexcept {
  return mmimage$cxxbridge1$ShimImagePixelData2DF64$height(*this);
}

MMIMAGE_API_EXPORT ::rust::Slice<const ::mmimage::Pixel2DF64> ShimImagePixelData2DF64::data() const noexcept {
  return ::rust::impl<::rust::Slice<const ::mmimage::Pixel2DF64>>::slice(mmimage$cxxbridge1$ShimImagePixelData2DF64$data(*this));
}

MMIMAGE_API_EXPORT ::rust::Slice<::mmimage::Pixel2DF64> ShimImagePixelData2DF64::data_mut() noexcept {
  return ::rust::impl<::rust::Slice<::mmimage::Pixel2DF64>>::slice(mmimage$cxxbridge1$ShimImagePixelData2DF64$data_mut(*this));
}

MMIMAGE_API_EXPORT ::rust::Box<::mmimage::ShimImagePixelData2DF64> shim_create_image_pixel_data_2d_f64_box() noexcept {
  return ::rust::Box<::mmimage::ShimImagePixelData2DF64>::from_raw(mmimage$cxxbridge1$shim_create_image_pixel_data_2d_f64_box());
}
...
MMIMAGE_API_EXPORT void shim_create_image_rgba_f32(::std::size_t image_width, ::std::size_t image_height, ::rust::Box<::mmimage::ShimImagePixelDataRgbaF32> &out_pixel_data) noexcept {
  mmimage$cxxbridge1$shim_create_image_rgba_f32(image_width, image_height, out_pixel_data);
}

MMIMAGE_API_EXPORT void shim_create_image_2d_f64(::std::size_t image_width, ::std::size_t image_height, ::rust::Box<::mmimage::ShimImagePixelData2DF64> &out_pixel_data) noexcept {
  mmimage$cxxbridge1$shim_create_image_2d_f64(image_width, image_height, out_pixel_data);
}

MMIMAGE_API_EXPORT bool shim_image_read_pixels_exr_rgba_f32(::rust::Str file_path, ::rust::Box<::mmimage::ShimImageMetaData> &out_meta_data, ::rust::Box<::mmimage::ShimImagePixelDataRgbaF32> &out_pixel_data) noexcept {
  return mmimage$cxxbridge1$shim_image_read_pixels_exr_rgba_f32(file_path, out_meta_data, out_pixel_data);
}
...
MMIMAGE_API_EXPORT bool shim_image_write_pixels_exr_rgba_f32(::rust::Str file_path, ::mmimage::ImageExrEncoder exr_encoder, const ::rust::Box<::mmimage::ShimImageMetaData> &in_meta_data, const ::rust::Box<::mmimage::ShimImagePixelDataRgbaF32> &in_pixel_data) noexcept {
  return mmimage$cxxbridge1$shim_image_write_pixels_exr_rgba_f32(file_path, exr_encoder, in_meta_data, in_pixel_data);
}
} // namespace mmimage

extern "C" {
::mmimage::ShimImagePixelDataRgbaF32 *cxxbridge1$box$mmimage$ShimImagePixelDataRgbaF32$alloc() noexcept;
void cxxbridge1$box$mmimage$ShimImagePixelDataRgbaF32$dealloc(::mmimage::ShimImagePixelDataRgbaF32 *) noexcept;
void cxxbridge1$box$mmimage$ShimImagePixelDataRgbaF32$drop(::rust::Box<::mmimage::ShimImagePixelDataRgbaF32> *ptr) noexcept;

::mmimage::ShimImagePixelData2DF64 *cxxbridge1$box$mmimage$ShimImagePixelData2DF64$alloc() noexcept;
void cxxbridge1$box$mmimage$ShimImagePixelData2DF64$dealloc(::mmimage::ShimImagePixelData2DF64 *) noexcept;
void cxxbridge1$box$mmimage$ShimImagePixelData2DF64$drop(::rust::Box<::mmimage::ShimImagePixelData2DF64> *ptr) noexcept;
...
inline namespace cxxbridge1 {
template <>
MMIMAGE_API_EXPORT ::mmimage::ShimImagePixelDataRgbaF32 *Box<::mmimage::ShimImagePixelDataRgbaF32>::allocation::alloc() noexcept {
  return cxxbridge1$box$mmimage$ShimImagePixelDataRgbaF32$alloc();
}
template <>
MMIMAGE_API_EXPORT void Box<::mmimage::ShimImagePixelDataRgbaF32>::allocation::dealloc(::mmimage::ShimImagePixelDataRgbaF32 *ptr) noexcept {
  cxxbridge1$box$mmimage$ShimImagePixelDataRgbaF32$dealloc(ptr);
}
template <>
MMIMAGE_API_EXPORT void Box<::mmimage::ShimImagePixelDataRgbaF32>::drop() noexcept {
  cxxbridge1$box$mmimage$ShimImagePixelDataRgbaF32$drop(this);
}
template <>
MMIMAGE_API_EXPORT ::mmimage::ShimImagePixelData2DF64 *Box<::mmimage::ShimImagePixelData2DF64>::allocation::alloc() noexcept {
  return cxxbridge1$box$mmimage$ShimImagePixelData2DF64$alloc();
}
template <>
MMIMAGE_API_EXPORT void Box<::mmimage::ShimImagePixelData2DF64>::allocation::dealloc(::mmimage::ShimImagePixelData2DF64 *ptr) noexcept {
  cxxbridge1$box$mmimage$ShimImagePixelData2DF64$dealloc(ptr);
}
template <>
MMIMAGE_API_EXPORT void Box<::mmimage::ShimImagePixelData2DF64>::drop() noexcept {
