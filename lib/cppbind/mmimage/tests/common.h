...
static bool test_print_metadata_named_attributes(
    const char *test_name, mmimage::ImageMetaData &meta_data) {
...
static bool test_print_metadata_fields(const char *test_name,
