...
struct ShimDistortionLayers final : public ::rust::Opaque {
  ...
  MMLENS_API_EXPORT ::std::uint8_t get_layer_count() const noexcept;
  MMLENS_API_EXPORT ::mmlens::LensModelType layer_lens_model_type(::std::uint8_t layer_num) const noexcept;
  MMLENS_API_EXPORT ::mmlens::OptionParameters3deClassic layer_parameters_3de_classic(::std::uint8_t layer_num, ::std::uint16_t frame) const noexcept;
...
::std::uint8_t mmlens$cxxbridge1$ShimDistortionLayers$get_layer_count(const ::mmlens::ShimDistortionLayers &self) noexcept;
...
::mmlens::OptionParameters3deClassic mmlens$cxxbridge1$ShimDistortionLayers$layer_parameters_3de_classic(const ::mmlens::ShimDistortionLayers &self, ::std::uint8_t layer_num, ::std::uint16_t frame) noexcept;
...
MMLENS_API_EXPORT ::std::uint8_t ShimDistortionLayers::get_layer_count() const noexcept {
  return mmlens$cxxbridge1$ShimDistortionLayers$get_layer_count(*this);
}
...
MMLENS_API_EXPORT ::mmlens::OptionParameters3deClassic ShimDistortionLayers::layer_parameters_3de_classic(::std::uint8_t layer_num, ::std::uint16_t frame) const noexcept {
  return mmlens$cxxbridge1$ShimDistortionLayers$layer_parameters_3de_classic(*this, layer_num, frame);
}
