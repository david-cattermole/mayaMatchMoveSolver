//
// Copyright (C) 2023, 2026 David Cattermole.
//
...
// Re-export from mmio to avoid duplication.
pub use mmio_rust::nuke_lens_common::MAX_LENS_PARAMETER_COUNT;
pub use mmio_rust::nuke_lens_common::STATIC_FRAME_NUMBER;
