...
fn bench_rosenbrock_config_comparison(c: &mut Criterion) {
    let mut group = c.benchmark_group("rosenbrock_config_comparison");
...
criterion_group!(
    benches,
    bench_rosenbrock_solver_comparison,
    bench_rosenbrock_config_comparison
);
