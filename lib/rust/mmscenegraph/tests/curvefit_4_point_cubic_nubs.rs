...
#[test]
fn curvefit_4_point_cubic_nubs_raw() -> Result<()> {
    let chart_title = "curvefit_4_point_cubic_nubs_raw";
    let in_reference_file_name = "linear_4_point_raw.chan";
    let in_file_name = "linear_4_point_raw.chan";
    let out_file_name = "curvefit_4_point_cubic_nubs_raw.png";
    let n_points = 4;
    ...
    //
    // CubicNUBS will produce different control points than linear
    // interpolation.
...
#[test]
fn curvefit_4_point_cubic_nubs_variance1() -> Result<()> {
    let chart_title = "curvefit_4_point_cubic_nubs_variance1";
    let in_reference_file_name = "linear_4_point_raw.chan";
    let in_file_name = "linear_4_point_variance1.chan";
    let out_file_name = "curvefit_4_point_cubic_nubs_variance1.png";
    let n_points = 4;
    let interpolation_method = Interpolation::CubicNUBS;
...
#[test]
fn curvefit_4_point_cubic_nubs_variance2() -> Result<()> {
    let chart_title = "curvefit_4_point_cubic_nubs_variance2";
    let in_reference_file_name = "linear_4_point_raw.chan";
    let in_file_name = "linear_4_point_variance2.chan";
    let out_file_name = "curvefit_4_point_cubic_nubs_variance2.png";
    let n_points = 4;
    let interpolation_method = Interpolation::CubicNUBS;
...
#[test]
fn curvefit_4_point_cubic_nubs_variance3() -> Result<()> {
    let chart_title = "curvefit_4_point_cubic_nubs_variance3";
    let in_reference_file_name = "linear_4_point_raw.chan";
    let in_file_name = "linear_4_point_variance3.chan";
    let out_file_name = "curvefit_4_point_cubic_nubs_variance3.png";
    let n_points = 4;
    let interpolation_method = Interpolation::CubicNUBS;
...
#[test]
fn curvefit_4_point_cubic_nubs_variance4() -> Result<()> {
    let chart_title = "curvefit_4_point_cubic_nubs_variance4";
    let in_reference_file_name = "linear_4_point_raw.chan";
    let in_file_name = "linear_4_point_variance4.chan";
    let out_file_name = "curvefit_4_point_cubic_nubs_variance4.png";
    let n_points = 4;
    let interpolation_method = Interpolation::CubicNUBS;
