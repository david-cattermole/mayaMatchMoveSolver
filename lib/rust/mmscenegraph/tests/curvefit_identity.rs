...
fn identity_raw() -> Result<()> {
    let chart_title = "curvefit_identity_raw";
    let in_reference_file_name = "identity_raw.chan";
    let in_file_name = "identity_raw.chan";
    let out_file_name = "curvefit_identity_raw.png";
...
fn identity_variance1() -> Result<()> {
    let chart_title = "curvefit_identity_variance1";
    let in_reference_file_name = "identity_raw.chan";
    let in_file_name = "identity_variance1.chan";
    let out_file_name = "curvefit_identity_variance1.png";
...
fn identity_variance2() -> Result<()> {
    let chart_title = "curvefit_identity_variance2";
    let in_reference_file_name = "identity_raw.chan";
    let in_file_name = "identity_variance2.chan";
    let out_file_name = "curvefit_identity_variance2.png";
...
fn identity_variance3() -> Result<()> {
    let chart_title = "curvefit_identity_variance3";
    let in_reference_file_name = "identity_raw.chan";
    let in_file_name = "identity_variance3.chan";
    let out_file_name = "curvefit_identity_variance3.png";
...
fn identity_variance4() -> Result<()> {
    let chart_title = "curvefit_identity_variance4";
    let in_reference_file_name = "identity_raw.chan";
    let in_file_name = "identity_variance4.chan";
    let out_file_name = "curvefit_identity_variance4.png";
