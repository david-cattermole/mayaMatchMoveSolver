...
fn linear_2_point_raw() -> Result<()> {
    let chart_title = "curvefit_linear_2_point_raw";
    let in_reference_file_name = "linear_2_point_raw.chan";
    let in_file_name = "linear_2_point_raw.chan";
    let out_file_name = "curvefit_linear_2_point_raw.png";
...
fn linear_2_point_variance1() -> Result<()> {
    let chart_title = "curvefit_linear_2_point_variance1";
    let in_reference_file_name = "linear_2_point_raw.chan";
    let in_file_name = "linear_2_point_variance1.chan";
    let out_file_name = "curvefit_linear_2_point_variance1.png";
...
fn linear_2_point_variance2() -> Result<()> {
    let chart_title = "curvefit_linear_2_point_variance2";
    let in_reference_file_name = "linear_2_point_raw.chan";
    let in_file_name = "linear_2_point_variance2.chan";
    let out_file_name = "curvefit_linear_2_point_variance2.png";
...
fn linear_2_point_variance3() -> Result<()> {
    let chart_title = "curvefit_linear_2_point_variance3";
    let in_reference_file_name = "linear_2_point_raw.chan";
    let in_file_name = "linear_2_point_variance3.chan";
    let out_file_name = "curvefit_linear_2_point_variance3.png";
...
fn linear_2_point_variance4() -> Result<()> {
    let chart_title = "curvefit_linear_2_point_variance4";
    let in_reference_file_name = "linear_2_point_raw.chan";
    let in_file_name = "linear_2_point_variance4.chan";
    let out_file_name = "curvefit_linear_2_point_variance4.png";
