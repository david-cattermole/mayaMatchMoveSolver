...
//! Bundle adjustment tests using the Blasterwalk dataset.
...
fn run_bundle_adjustment_blasterwalk(
    is_noisy: bool,
...
#[test]
fn test_bundle_adjustment_clean_blasterwalk_dense_lm() -> Result<()> {
    run_bundle_adjustment_blasterwalk(
        false,
...
#[test]
fn test_bundle_adjustment_noisy_blasterwalk_dense_lm() -> Result<()> {
    run_bundle_adjustment_blasterwalk(true, BundleAdjustmentSolverType::DenseLM)
}
