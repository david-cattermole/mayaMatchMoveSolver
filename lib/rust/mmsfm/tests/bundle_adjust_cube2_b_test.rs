...
//! Bundle adjustment tests using the cube2 B dataset.
...
fn run_bundle_adjustment_cube2_b(
    is_noisy: bool,
...
#[test]
fn test_bundle_adjustment_clean_cube2_b_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube2_b(false, BundleAdjustmentSolverType::DenseLM)
}

#[test]
fn test_bundle_adjustment_noisy_cube2_b_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube2_b(true, BundleAdjustmentSolverType::DenseLM)
}
