...
//! Bundle adjustment tests using the cube2 D dataset.
...
fn run_bundle_adjustment_cube2_d(
    is_noisy: bool,
...
#[test]
fn test_bundle_adjustment_clean_cube2_d_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube2_d(false, BundleAdjustmentSolverType::DenseLM)
}

#[test]
fn test_bundle_adjustment_noisy_cube2_d_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube2_d(true, BundleAdjustmentSolverType::DenseLM)
}
