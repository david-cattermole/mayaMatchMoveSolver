...
//! Bundle adjustment tests using the cube A dataset.
...
fn run_bundle_adjustment_cube_a(
    is_noisy: bool,
...
#[test]
fn test_bundle_adjustment_clean_cube_a_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube_a(false, BundleAdjustmentSolverType::DenseLM)
}

#[test]
fn test_bundle_adjustment_noisy_cube_a_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube_a(true, BundleAdjustmentSolverType::DenseLM)
}
