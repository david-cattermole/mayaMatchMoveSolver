...
//! Bundle adjustment tests using the cube B dataset.
...
fn run_bundle_adjustment_cube_b(
    is_noisy: bool,
...
#[test]
fn test_bundle_adjustment_clean_cube_b_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube_b(false, BundleAdjustmentSolverType::DenseLM)
}

#[test]
fn test_bundle_adjustment_noisy_cube_b_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube_b(true, BundleAdjustmentSolverType::DenseLM)
}
