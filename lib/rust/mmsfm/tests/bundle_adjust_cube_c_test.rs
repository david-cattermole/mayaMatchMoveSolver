...
//! Bundle adjustment tests using the cube C dataset.
...
fn run_bundle_adjustment_cube_c(
    is_noisy: bool,
...
#[test]
fn test_bundle_adjustment_clean_cube_c_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube_c(false, BundleAdjustmentSolverType::DenseLM)
}

#[test]
fn test_bundle_adjustment_noisy_cube_c_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube_c(true, BundleAdjustmentSolverType::DenseLM)
}
