...
//! Bundle adjustment tests using the cube D dataset.
...
fn run_bundle_adjustment_cube_d(
    is_noisy: bool,
...
#[test]
fn test_bundle_adjustment_clean_cube_d_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube_d(false, BundleAdjustmentSolverType::DenseLM)
}

#[test]
fn test_bundle_adjustment_noisy_cube_d_dense_lm() -> Result<()> {
    run_bundle_adjustment_cube_d(true, BundleAdjustmentSolverType::DenseLM)
}
