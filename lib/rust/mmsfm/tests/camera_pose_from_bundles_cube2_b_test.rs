...
fn run_camera_pose_from_bundles_cube2_b(is_noisy: bool) -> Result<()> {
    let (mut markers, _frame_range) =
        load_marker_data("test_cube2_b_markers_v1_fmt.uv")?;
    ...
    let (
        ...
        ("Cube2 B (clean)", DataCondition::Clean, None, None, None)
    };
    ...
    ground_truth_3d
        .insert("pCube1_locator1_MKR", Point3::new(-3.75, 3.75, -11.25));
    ground_truth_3d
        .insert("pCube1_locator2_MKR", Point3::new(3.75, 3.75, -11.25));
    ground_truth_3d
        .insert("pCube1_locator3_MKR", Point3::new(-3.75, -3.75, -11.25));
    ground_truth_3d
        .insert("pCube1_locator4_MKR", Point3::new(3.75, -3.75, -11.25));
    ground_truth_3d
        .insert("pCube1_locator5_MKR", Point3::new(-3.75, 3.75, -18.75));
    ground_truth_3d
        .insert("pCube1_locator6_MKR", Point3::new(3.75, 3.75, -18.75));
    ground_truth_3d
        .insert("pCube1_locator7_MKR", Point3::new(-3.75, -3.75, -18.75));
    ground_truth_3d
        .insert("pCube1_locator8_MKR", Point3::new(3.75, -3.75, -18.75));
    ground_truth_3d.insert(
        "pCube2_locator9_MKR",
        Point3::new(4.833748344146057, 3.75, -24.99699528531099),
    );
    ground_truth_3d.insert(
        "pCube2_locator10_MKR",
        Point3::new(12.333748344146057, 3.75, -24.99699528531099),
    );
    ground_truth_3d.insert(
    ...
    ground_truth_3d.insert(
        ...
        Point3::new(4.833748344146057, 3.75, -32.49699528531099),
    );
    ground_truth_3d.insert(
        "pCube2_locator14_MKR",
        Point3::new(12.333748344146057, 3.75, -32.49699528531099),
    );
    ground_truth_3d.insert(
...
#[test]
fn test_camera_pose_from_bundles_clean_cube2_b() -> Result<()> {
    run_camera_pose_from_bundles_cube2_b(false)
}

#[test]
fn test_camera_pose_from_bundles_noisy_cube2_b() -> Result<()> {
    run_camera_pose_from_bundles_cube2_b(true)
}
