...
use crate::common::run_camera_pose_from_bundles_dataset_test;
use crate::common::visualization::scene::EpipolarLineOptions;
...
fn run_camera_pose_from_bundles_cube2_c(is_noisy: bool) -> Result<()> {
    ...
    let (
        ...
        ("Cube2 C (clean)", DataCondition::Clean, None, None, None)
    };
    ...
    ground_truth_3d.insert(
        "pCube2_locator9_MKR",
        Point3::new(-3.75, 3.75, -54.51425035219598),
    );
    ground_truth_3d.insert(
    ...
    ground_truth_3d.insert(
        ...
        Point3::new(-3.75, 3.75, -62.01425035219598),
    );
    ground_truth_3d.insert(
...
#[test]
fn test_camera_pose_from_bundles_clean_cube2_c() -> Result<()> {
    run_camera_pose_from_bundles_cube2_c(false)
}

#[test]
fn test_camera_pose_from_bundles_noisy_cube2_c() -> Result<()> {
    run_camera_pose_from_bundles_cube2_c(true)
}
