...
fn run_camera_pose_from_bundles_cube2_d(is_noisy: bool) -> Result<()> {
    ...
    let (
        ...
        ("Cube2 D (clean)", DataCondition::Clean, None, None, None)
    };
    ...
    ground_truth_3d.insert(
        "pCube2_locator9_MKR",
        Point3::new(-3.75, 3.75, -97.35448170977782),
    );
    ground_truth_3d.insert(
    ...
    ground_truth_3d.insert(
        ...
        Point3::new(-3.75, 3.75, -104.85448170977782),
    );
    ground_truth_3d.insert(
...
#[test]
fn test_camera_pose_from_bundles_clean_cube2_d() -> Result<()> {
    run_camera_pose_from_bundles_cube2_d(false)
}

#[test]
fn test_camera_pose_from_bundles_noisy_cube2_d() -> Result<()> {
    run_camera_pose_from_bundles_cube2_d(true)
}
