...
fn run_camera_pose_from_bundles_cube_a(is_noisy: bool) -> Result<()> {
    ...
    let (
        ...
        ("Cube A (clean)", DataCondition::Clean, None, None, None)
    };
...
#[test]
fn test_camera_pose_from_bundles_clean_cube_a() -> Result<()> {
    run_camera_pose_from_bundles_cube_a(false)
}

#[test]
fn test_camera_pose_from_bundles_noisy_cube_a() -> Result<()> {
    run_camera_pose_from_bundles_cube_a(true)
}
