...
fn run_camera_pose_from_bundles_cube_d(is_noisy: bool) -> Result<()> {
    ...
    let (
        ...
        ("Cube D (clean)", DataCondition::Clean, None, None, None)
    };
...
#[test]
fn test_camera_pose_from_bundles_clean_cube_d() -> Result<()> {
    run_camera_pose_from_bundles_cube_d(false)
}

#[test]
fn test_camera_pose_from_bundles_noisy_cube_d() -> Result<()> {
    run_camera_pose_from_bundles_cube_d(true)
}
