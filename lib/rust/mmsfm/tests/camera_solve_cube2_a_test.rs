...
//! Integration test for complete camera solve using cube2 A dataset.
...
fn test_camera_solve_clean_cube2_a_dense_lm() -> Result<()> {
    run_camera_solve_cube2_a(false, BundleAdjustmentSolverType::DenseLM)
}

#[test]
fn test_camera_solve_clean_cube2_a_sparse_lm() -> Result<()> {
    run_camera_solve_cube2_a(
        false,
...
#[test]
#[ignore] // TODO: Make this run faster so we can test faster.
fn test_camera_solve_noisy_cube2_a_dense_lm() -> Result<()> {
    run_camera_solve_cube2_a(true, BundleAdjustmentSolverType::DenseLM)
}

#[test]
#[ignore]
fn test_camera_solve_noisy_cube2_a_sparse_lm() -> Result<()> {
    run_camera_solve_cube2_a(
        true,
        BundleAdjustmentSolverType::SparseLevenbergMarquardt,
    )
