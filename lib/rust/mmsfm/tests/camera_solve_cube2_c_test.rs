...
//! Integration test for complete camera solve using cube2 C dataset.
...
fn test_camera_solve_clean_cube2_c_dense_lm() -> Result<()> {
    run_camera_solve_cube2_c(false, BundleAdjustmentSolverType::DenseLM)
}

#[test]
fn test_camera_solve_clean_cube2_c_sparse_lm() -> Result<()> {
    run_camera_solve_cube2_c(
        false,
...
#[test]
#[ignore] // TODO: Make this run faster so we can test faster.
fn test_camera_solve_noisy_cube2_c_dense_lm() -> Result<()> {
    run_camera_solve_cube2_c(true, BundleAdjustmentSolverType::DenseLM)
}

#[test]
#[ignore]
fn test_camera_solve_noisy_cube2_c_sparse_lm() -> Result<()> {
    run_camera_solve_cube2_c(
        true,
        BundleAdjustmentSolverType::SparseLevenbergMarquardt,
    )
