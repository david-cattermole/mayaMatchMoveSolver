...
# Solver Types
#
# Values as defined in "./src/mmSolver/adjust/adjust_defines.h".
...
SOLVER_TYPE_CERES_LINE_SEARCH_LBFGS_DER = 5
...
# Affects Graph Modes - used for mmSolverAffects command.
AFFECTS_GRAPH_MODE_NORMAL = 'normal'
AFFECTS_GRAPH_MODE_NAME_BASED = 'name_based'
AFFECTS_GRAPH_MODE_OBJECT = 'object'
AFFECTS_GRAPH_MODE_SIMPLE = 'simple'
AFFECTS_GRAPH_MODE_DEFAULT = AFFECTS_GRAPH_MODE_SIMPLE
AFFECTS_GRAPH_MODE_LIST = [
    AFFECTS_GRAPH_MODE_NORMAL,
    AFFECTS_GRAPH_MODE_NAME_BASED,
    AFFECTS_GRAPH_MODE_OBJECT,
    AFFECTS_GRAPH_MODE_SIMPLE,
]
AFFECTS_GRAPH_MODE_NORMAL_LABEL = "Dependency-Graph"
AFFECTS_GRAPH_MODE_NAME_BASED_LABEL = "Name-Based"
AFFECTS_GRAPH_MODE_OBJECT_LABEL = "Object"
AFFECTS_GRAPH_MODE_SIMPLE_LABEL = "Simple"
AFFECTS_GRAPH_MODE_LABEL_LIST = [
    AFFECTS_GRAPH_MODE_NORMAL_LABEL,
    AFFECTS_GRAPH_MODE_NAME_BASED_LABEL,
    AFFECTS_GRAPH_MODE_OBJECT_LABEL,
    AFFECTS_GRAPH_MODE_SIMPLE_LABEL,
]
...
SOLVER_CAM_SOLVER_TYPE_DEFAULT_VALUE = SOLVER_TYPE_CERES_LMDER
SOLVER_CAM_SOLVER_VERSION_DEFAULT_VALUE = SOLVER_VERSION_ONE
