...
CONTROLLER_TYPE_LIST = [CONTROLLER_TYPE_WORLD_SPACE,
...
COLUMN_INDICES_LIST = [COLUMN_CONTROLLER_NAME_INDEX,
...
PIVOT_TYPE_ITEM_LIST = [PIVOT_TYPE_ITEM_STATIC,
...
BAKE_ITEM_LIST = [BAKE_ITEM_FULL_BAKE,
...
SPACE_ITEM_LIST = [SPACE_ITEM_WORLD_SPACE,
