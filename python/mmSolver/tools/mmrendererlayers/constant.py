...
EDGE_DETECT_MODE_3D_SILHOUETTE = '3D Silhouette'
EDGE_DETECT_MODE_DEFAULT_VALUE = EDGE_DETECT_MODE_3D_SILHOUETTE
EDGE_DETECT_MODE_ENUM_VALUES = {
    EDGE_DETECT_MODE_SOBEL: 0,
    EDGE_DETECT_MODE_FREI_CHEN: 1,
    EDGE_DETECT_MODE_3D_SILHOUETTE: 2,
}
