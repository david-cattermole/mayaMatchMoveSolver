...
import mmSolver.tools.screenspacerigbake2.ui.ui_screenspacerigbake_layout as ui_layout
...
class ScreenSpaceRigBakeLayout(QtWidgets.QWidget, ui_layout.Ui_Form):
    ...
    def create_connections(self):
        # Button clicked
        self.createScreenSpaceRigButton.clicked.connect(self.create_screen_space_rig_clicked)
