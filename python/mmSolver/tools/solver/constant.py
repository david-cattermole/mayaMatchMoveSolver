...
SOLVER_TYPE_CERES_LINE_SEARCH_LBFGS_DER = (
    mmapi_const.SOLVER_TYPE_CERES_LINE_SEARCH_LBFGS_DER
)
SOLVER_TYPE_LIST = [
    SOLVER_TYPE_DEFAULT,
...
SOLVER_TYPE_CERES_LINE_SEARCH_LBFGS_DER_LABEL = 'Ceres Line-Search (experimental)'
SOLVER_TYPE_LABEL_LIST = [
    ...
    SOLVER_TYPE_CERES_LINE_SEARCH_LBFGS_DER_LABEL,
]
