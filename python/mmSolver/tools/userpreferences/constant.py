...
# "MM Renderer - Background Node Types" preference.
MM_RENDERER_BACKGROUND_NODE_TYPES_KEY = 'mmrenderer/background_node_types'
MM_RENDERER_BACKGROUND_NODE_TYPES_TYPE = TYPE_STRING
MM_RENDERER_BACKGROUND_NODE_TYPES_DEFAULT_VALUE = 'imagePlane mmImagePlaneShape'
...
VALUES_MAP = {
    ...
    MM_RENDERER_BACKGROUND_NODE_TYPES_KEY: None,
}
...
DEFAULT_VALUE_MAP = {
    ...
    MM_RENDERER_BACKGROUND_NODE_TYPES_KEY: MM_RENDERER_BACKGROUND_NODE_TYPES_DEFAULT_VALUE,
}
...
VALUE_TYPE_MAP = {
    ...
    MM_RENDERER_BACKGROUND_NODE_TYPES_KEY: MM_RENDERER_BACKGROUND_NODE_TYPES_TYPE,
}
