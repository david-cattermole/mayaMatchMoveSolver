...
DEVKIT_LOCATION=${HOME}/maya2020_devkitBase
...
#
# The "${HOME}/Library/Preferences/Autodesk/maya/2020/modules"
# directory is automatically searched for Maya module (.mod)
# files. Therefore we can install directly.
#
INSTALL_MODULE_DIR=${HOME}/Library/Preferences/Autodesk/maya/2020/modules
