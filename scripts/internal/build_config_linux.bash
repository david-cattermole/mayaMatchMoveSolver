...
# vcpkg directory configuration.
BUILD_VCPKG_DIR_NAME="build_vcpkg"
BUILD_VCPKG_DIR_BASE="${BUILD_DIR_BASE}/${BUILD_VCPKG_DIR_NAME}"
BUILD_VCPKG_INSTALL_DIR="${BUILD_VCPKG_DIR_BASE}/install/maya${MAYA_VERSION}_linux"
...
export BUILD_VCPKG_DIR_NAME BUILD_VCPKG_DIR_BASE BUILD_VCPKG_INSTALL_DIR
...
if [ "$VERBOSE" = "1" ]; then
    ...
    echo "  BUILD_VCPKG_DIR_BASE: ${BUILD_VCPKG_DIR_BASE}"
    echo "  BUILD_VCPKG_INSTALL_DIR: ${BUILD_VCPKG_INSTALL_DIR}"
fi
