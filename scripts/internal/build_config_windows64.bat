...
SET BUILD_VCPKG_DIR_NAME=build_vcpkg
SET BUILD_VCPKG_DIR_BASE=%BUILD_DIR_BASE%\%BUILD_VCPKG_DIR_NAME%
SET BUILD_VCPKG_INSTALL_DIR=%BUILD_VCPKG_DIR_BASE%\install\maya%MAYA_VERSION%_windows64
