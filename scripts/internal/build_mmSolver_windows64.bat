...
SET GLOG_ROOT="%PROJECT_ROOT%\external\install\maya%MAYA_VERSION%_windows64\glog"
SET GLOG_INCLUDE_DIR="%PROJECT_ROOT%\external\install\maya%MAYA_VERSION%_windows64\glog\include"
SET GLOG_LIB_PATH="%PROJECT_ROOT%\external\install\maya%MAYA_VERSION%_windows64\glog\lib"
