...
# ---------------------------------------------------------------------
#
# Activates the Python development environment for Maya 2027.
#
# This script should be sourced, NOT called, for example:
# $ source scripts/python_venv_activate_maya2027.bash
#
...
export PYTHON_VIRTUAL_ENV_DIR_NAME=python_venv_linux_maya2027
