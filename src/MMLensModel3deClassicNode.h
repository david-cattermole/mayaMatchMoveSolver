 ...
 * ====================================================================
 *
 * Define a lens. The lens is a 3DEqualizer "classic" lens distortion
 * model.
 */

#ifndef MM_LENS_MODEL_3DE_CLASSIC_NODE_H
#define MM_LENS_MODEL_3DE_CLASSIC_NODE_H
...
public:
    ...
    virtual ~MMLensModel3deClassicNode();
