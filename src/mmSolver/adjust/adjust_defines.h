...
// Dense LM solver using 'ceres', with custom jacobian, using a
// trust-region Levenberg-Marquardt algorithm.
#define SOLVER_TYPE_CERES_LINE_SEARCH_LBFGS_DER (5)
#define SOLVER_TYPE_CERES_LINE_SEARCH_LBFGS_DER_NAME "ceres_line_search_lbfgs_der"
...
// Ceres Line Search L-BFGS Solver default flag values, using custom
// finite differencing.
//
#define CERES_LINE_SEARCH_LBFGS_DER_ITERATIONS_DEFAULT_VALUE (1000)
#define CERES_LINE_SEARCH_LBFGS_DER_TAU_DEFAULT_VALUE (1E4)
#define CERES_LINE_SEARCH_LBFGS_DER_FUNCTION_TOLERANCE_DEFAULT_VALUE (1E-6)
#define CERES_LINE_SEARCH_LBFGS_DER_PARAMETER_TOLERANCE_DEFAULT_VALUE (1E-10)
#define CERES_LINE_SEARCH_LBFGS_DER_GRADIENT_TOLERANCE_DEFAULT_VALUE (1E-8)
#define CERES_LINE_SEARCH_LBFGS_DER_DELTA_DEFAULT_VALUE (1E-04)
// ceres lmder supports both forward '0=forward' and 'central' auto-diff'ing.
#define CERES_LINE_SEARCH_LBFGS_DER_AUTO_DIFF_TYPE_DEFAULT_VALUE (AUTO_DIFF_TYPE_FORWARD)
#define CERES_LINE_SEARCH_LBFGS_DER_AUTO_PARAM_SCALE_DEFAULT_VALUE \
    (1)  // default is 'on=1 (mode=1)'
#define CERES_LINE_SEARCH_LBFGS_DER_ROBUST_LOSS_TYPE_DEFAULT_VALUE (ROBUST_LOSS_TYPE_TRIVIAL)
#define CERES_LINE_SEARCH_LBFGS_DER_ROBUST_LOSS_SCALE_DEFAULT_VALUE (1.0)
#define CERES_LINE_SEARCH_LBFGS_DER_SUPPORT_AUTO_DIFF_FORWARD_VALUE true
#define CERES_LINE_SEARCH_LBFGS_DER_SUPPORT_AUTO_DIFF_CENTRAL_VALUE true
#define CERES_LINE_SEARCH_LBFGS_DER_SUPPORT_PARAMETER_BOUNDS_VALUE true
#define CERES_LINE_SEARCH_LBFGS_DER_SUPPORT_ROBUST_LOSS_VALUE false
