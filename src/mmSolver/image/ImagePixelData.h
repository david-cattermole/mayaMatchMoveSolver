...
#ifndef MM_SOLVER_IMAGE_IMAGE_PIXEL_DATA_H
#define MM_SOLVER_IMAGE_IMAGE_PIXEL_DATA_H
...
struct ImagePixelData {
    ...
    ImagePixelData(void *pixel_data, const uint32_t width,
...
#endif  // MM_SOLVER_IMAGE_IMAGE_PIXEL_DATA_H
