...
public:
    ...
    LensModel3deAnamorphicDeg4RotateSqueezeXY()
            ...
            , m_squeeze_x(1.0)
            , m_squeeze_y(1.0)
            , m_lensPlugin(std::unique_ptr<LensPluginBase>(new LensPluginAnamorphicDeg4RotateSqueezeXY()))
        {}

    LensModel3deAnamorphicDeg4RotateSqueezeXY(
        const double degree2_cx02,
        const double degree2_cy02,
        const double degree2_cx22,
        const double degree2_cy22,
        const double degree4_cx04,
        const double degree4_cy04,
        const double degree4_cx24,
        const double degree4_cy24,
        const double degree4_cx44,
        const double degree4_cy44,
    ...
    cloneAsUniquePtr() const override {
        return std::unique_ptr<LensModel>(new LensModel3deAnamorphicDeg4RotateSqueezeXY(*this));
    }

    std::shared_ptr<LensModel>
    cloneAsSharedPtr() const override {
        return std::shared_ptr<LensModel>(new LensModel3deAnamorphicDeg4RotateSqueezeXY(*this));
    }
