...
#ifndef MM_SOLVER_RENDER_SILHOUETTE_RENDER_GLOBALS_NODE_H
#define MM_SOLVER_RENDER_SILHOUETTE_RENDER_GLOBALS_NODE_H
...
class RenderGlobalsSilhouetteNode : public MPxNode {
public:
    RenderGlobalsSilhouetteNode();

    ~RenderGlobalsSilhouetteNode() override;
...
#endif  // MM_SOLVER_RENDER_SILHOUETTE_RENDER_GLOBALS_NODE_H
