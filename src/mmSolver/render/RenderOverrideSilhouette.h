...
#ifndef MM_SOLVER_RENDER_SILHOUETTE_RENDER_OVERRIDE_H
#define MM_SOLVER_RENDER_SILHOUETTE_RENDER_OVERRIDE_H
...
#endif  // MAYA_MM_SOLVER_RENDER_SILHOUETTE_RENDER_OVERRIDE_H
