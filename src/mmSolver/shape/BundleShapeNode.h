...
#ifndef MM_BUNDLE_SHAPE_NODE_H
#define MM_BUNDLE_SHAPE_NODE_H
...
class BundleShapeNode : public MPxLocatorNode {
public:
    BundleShapeNode();

    ~BundleShapeNode() override;
