...
//     status = getNodeAttr(objPath, ImagePlaneShape2Node::m_draw_image_size,
//                          out_draw_image_size);
//     CHECK_MSTATUS(status);

//     status = getNodeAttr(objPath, ImagePlaneShape2Node::m_image_width,
//     width); CHECK_MSTATUS(status);

//     status = getNodeAttr(objPath, ImagePlaneShape2Node::m_image_height,
//     height); CHECK_MSTATUS(status);

//     status = getNodeAttr(objPath, ImagePlaneShape2Node::m_image_pixel_aspect,
//                          pixel_aspect);
//     CHECK_MSTATUS(status);
...
//     status = getNodeAttr(objPath, ImagePlaneShape2Node::m_draw_camera_size,
//                          out_draw_camera_size);
//     CHECK_MSTATUS(status);

//     status =
//         getNodeAttr(objPath, ImagePlaneShape2Node::m_camera_width_inch,
//         width);
//     CHECK_MSTATUS(status);

//     status = getNodeAttr(objPath, ImagePlaneShape2Node::m_camera_height_inch,
//                          height);
//     CHECK_MSTATUS(status);
