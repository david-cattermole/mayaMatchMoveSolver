...
MStatus ImagePlaneShape2Node::initialize() {
    ...
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_num_channels));
    ...
    MMSOLVER_CHECK_MSTATUS(nAttr.setKeyable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setMin(0));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_bytes_per_channel));
    ...
    MMSOLVER_CHECK_MSTATUS(tAttr.setStorable(true));
    MMSOLVER_CHECK_MSTATUS(tAttr.setUsedAsFilename(false));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_size_bytes));
    ...
    MMSOLVER_CHECK_MSTATUS(nAttr.setWritable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setDefault(1.0f, 1.0f, 1.0f));
    MMSOLVER_CHECK_MSTATUS(nAttr.setNiceNameOverride(MString("Gain")));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_color_gain));
    ...
    MMSOLVER_CHECK_MSTATUS(nAttr.setStorable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setKeyable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setSoftMin(exposure_soft_min));
    MMSOLVER_CHECK_MSTATUS(nAttr.setSoftMax(exposure_soft_max));
    MMSOLVER_CHECK_MSTATUS(nAttr.setNiceNameOverride(MString("Exposure")));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_color_exposure));
    ...
    MMSOLVER_CHECK_MSTATUS(nAttr.setStorable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setKeyable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setMin(gamma_min));
    MMSOLVER_CHECK_MSTATUS(nAttr.setSoftMax(gamma_soft_max));
    MMSOLVER_CHECK_MSTATUS(nAttr.setNiceNameOverride(MString("Gamma")));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_color_gamma));
    ...
    MMSOLVER_CHECK_MSTATUS(nAttr.setStorable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setKeyable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setMin(saturation_min));
    MMSOLVER_CHECK_MSTATUS(nAttr.setSoftMax(saturation_soft_max));
    MMSOLVER_CHECK_MSTATUS(nAttr.setNiceNameOverride(MString("Saturation")));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_color_saturation));
    ...
    MMSOLVER_CHECK_MSTATUS(nAttr.setStorable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setKeyable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setMin(soft_clip_min));
    MMSOLVER_CHECK_MSTATUS(nAttr.setMax(soft_clip_max));
    MMSOLVER_CHECK_MSTATUS(nAttr.setNiceNameOverride(MString("SoftClip")));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_color_soft_clip));
    ...
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_alpha_gain));
    ...
    MMSOLVER_CHECK_MSTATUS(status);
    MMSOLVER_CHECK_MSTATUS(eAttr.addField("RGBA", value_rgba));
    MMSOLVER_CHECK_MSTATUS(eAttr.addField("RGB", value_rgb));
    MMSOLVER_CHECK_MSTATUS(eAttr.addField("Red", value_red));
    MMSOLVER_CHECK_MSTATUS(eAttr.addField("Green", value_green));
    MMSOLVER_CHECK_MSTATUS(eAttr.addField("Blue", value_blue));
    MMSOLVER_CHECK_MSTATUS(eAttr.addField("Alpha", value_alpha));
    MMSOLVER_CHECK_MSTATUS(eAttr.addField("Luminance", value_luminance));
    MMSOLVER_CHECK_MSTATUS(eAttr.setStorable(true));
    MMSOLVER_CHECK_MSTATUS(eAttr.setKeyable(true));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_display_channel));
    ...
    MMSOLVER_CHECK_MSTATUS(nAttr.setConnectable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setKeyable(true));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_ignore_alpha));
    ...
    MMSOLVER_CHECK_MSTATUS(nAttr.setKeyable(true));
    MMSOLVER_CHECK_MSTATUS(
        nAttr.setNiceNameOverride(MString("Image Flip (Vertical)")));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_flip));
    ...
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_flop));
    ...
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_shader_is_transparent));

    m_image_frame_number =
        nAttr.create("imageFrameNumber", "imgfrmnmb", MFnNumericData::kInt, 1);
    MMSOLVER_CHECK_MSTATUS(nAttr.setStorable(true));
    MMSOLVER_CHECK_MSTATUS(nAttr.setKeyable(true));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_frame_number));

    // // Pixel Data Type
    // m_cache_pixel_data_type = eAttr.create(
    //     "cachePixelDataType", "cchpxldtyp",
    //     kDataTypeUnknown);
    // MMSOLVER_CHECK_MSTATUS(eAttr.addField("auto", kDataTypeUnknown));
    // MMSOLVER_CHECK_MSTATUS(eAttr.addField("uint8", kDataTypeUInt8));
    // MMSOLVER_CHECK_MSTATUS(eAttr.addField("uint16", kDataTypeUInt16));
    // MMSOLVER_CHECK_MSTATUS(eAttr.addField("half16", kDataTypeHalf16));
    // MMSOLVER_CHECK_MSTATUS(eAttr.addField("float32", kDataTypeFloat32));
    // MMSOLVER_CHECK_MSTATUS(eAttr.setStorable(true));
    ...
    MMSOLVER_CHECK_MSTATUS(tAttr.setStorable(true));
    MMSOLVER_CHECK_MSTATUS(tAttr.setUsedAsFilename(true));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_file_path));

    m_image_input_color_space = tAttr.create(
        "inputColorSpace", "incolspc", MFnData::kString, empty_string_data_obj);
    MMSOLVER_CHECK_MSTATUS(tAttr.setStorable(true));
    MMSOLVER_CHECK_MSTATUS(tAttr.setUsedAsFilename(false));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_input_color_space));
    ...
    MMSOLVER_CHECK_MSTATUS(tAttr.setStorable(true));
    MMSOLVER_CHECK_MSTATUS(tAttr.setUsedAsFilename(false));
    MMSOLVER_CHECK_MSTATUS(addAttribute(m_image_output_color_space));
