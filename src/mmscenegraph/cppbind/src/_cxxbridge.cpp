...
::std::size_t mmscenegraph$cxxbridge1$NodeId$operator$hash(const NodeId &) noexcept;
bool mmscenegraph$cxxbridge1$AttrId$operator$eq(const AttrId &, const AttrId &) noexcept;
bool mmscenegraph$cxxbridge1$AttrId$operator$lt(const AttrId &, const AttrId &) noexcept;
bool mmscenegraph$cxxbridge1$AttrId$operator$le(const AttrId &, const AttrId &) noexcept;
::std::size_t mmscenegraph$cxxbridge1$AttrId$operator$hash(const AttrId &) noexcept;
::std::size_t mmscenegraph$cxxbridge1$Translate2DAttrIds$operator$hash(const Translate2DAttrIds &) noexcept;
::std::size_t mmscenegraph$cxxbridge1$Translate3DAttrIds$operator$hash(const Translate3DAttrIds &) noexcept;
::std::size_t mmscenegraph$cxxbridge1$Rotate3DAttrIds$operator$hash(const Rotate3DAttrIds &) noexcept;
::std::size_t mmscenegraph$cxxbridge1$Scale3DAttrIds$operator$hash(const Scale3DAttrIds &) noexcept;
::std::size_t mmscenegraph$cxxbridge1$CameraAttrIds$operator$hash(const CameraAttrIds &) noexcept;
::std::size_t mmscenegraph$cxxbridge1$MarkerAttrIds$operator$hash(const MarkerAttrIds &) noexcept;
bool mmscenegraph$cxxbridge1$TransformNode$operator$eq(const TransformNode &, const TransformNode &) noexcept;
bool mmscenegraph$cxxbridge1$TransformNode$operator$lt(const TransformNode &, const TransformNode &) noexcept;
bool mmscenegraph$cxxbridge1$TransformNode$operator$le(const TransformNode &, const TransformNode &) noexcept;
::std::size_t mmscenegraph$cxxbridge1$TransformNode$operator$hash(const TransformNode &) noexcept;
bool mmscenegraph$cxxbridge1$BundleNode$operator$eq(const BundleNode &, const BundleNode &) noexcept;
bool mmscenegraph$cxxbridge1$BundleNode$operator$lt(const BundleNode &, const BundleNode &) noexcept;
bool mmscenegraph$cxxbridge1$BundleNode$operator$le(const BundleNode &, const BundleNode &) noexcept;
::std::size_t mmscenegraph$cxxbridge1$BundleNode$operator$hash(const BundleNode &) noexcept;
bool mmscenegraph$cxxbridge1$CameraNode$operator$eq(const CameraNode &, const CameraNode &) noexcept;
bool mmscenegraph$cxxbridge1$CameraNode$operator$lt(const CameraNode &, const CameraNode &) noexcept;
bool mmscenegraph$cxxbridge1$CameraNode$operator$le(const CameraNode &, const CameraNode &) noexcept;
::std::size_t mmscenegraph$cxxbridge1$CameraNode$operator$hash(const CameraNode &) noexcept;
bool mmscenegraph$cxxbridge1$MarkerNode$operator$eq(const MarkerNode &, const MarkerNode &) noexcept;
bool mmscenegraph$cxxbridge1$MarkerNode$operator$lt(const MarkerNode &, const MarkerNode &) noexcept;
bool mmscenegraph$cxxbridge1$MarkerNode$operator$le(const MarkerNode &, const MarkerNode &) noexcept;
::std::size_t mmscenegraph$cxxbridge1$MarkerNode$operator$hash(const MarkerNode &) noexcept;
...
::std::size_t mmscenegraph$cxxbridge1$ShimSceneGraph$num_transform_nodes(const ::mmscenegraph::ShimSceneGraph &self) noexcept;

::std::size_t mmscenegraph$cxxbridge1$ShimSceneGraph$num_bundle_nodes(const ::mmscenegraph::ShimSceneGraph &self) noexcept;

::std::size_t mmscenegraph$cxxbridge1$ShimSceneGraph$num_camera_nodes(const ::mmscenegraph::ShimSceneGraph &self) noexcept;

::std::size_t mmscenegraph$cxxbridge1$ShimSceneGraph$num_marker_nodes(const ::mmscenegraph::ShimSceneGraph &self) noexcept;
...
void mmscenegraph$cxxbridge1$ShimFlatScene$evaluate(::mmscenegraph::ShimFlatScene &self, const ::mmscenegraph::ShimAttrDataBlock &attrdb, ::rust::Slice<const ::std::uint32_t> frame_list) noexcept;
...
::std::size_t mmscenegraph$cxxbridge1$ShimEvaluationObjects$num_bundles(const ::mmscenegraph::ShimEvaluationObjects &self) noexcept;

::std::size_t mmscenegraph$cxxbridge1$ShimEvaluationObjects$num_markers(const ::mmscenegraph::ShimEvaluationObjects &self) noexcept;

::std::size_t mmscenegraph$cxxbridge1$ShimEvaluationObjects$num_cameras(const ::mmscenegraph::ShimEvaluationObjects &self) noexcept;

void mmscenegraph$cxxbridge1$ShimEvaluationObjects$add_bundle(::mmscenegraph::ShimEvaluationObjects &self, const ::mmscenegraph::BundleNode &bnd_node) noexcept;

void mmscenegraph$cxxbridge1$ShimEvaluationObjects$add_camera(::mmscenegraph::ShimEvaluationObjects &self, const ::mmscenegraph::CameraNode &cam_node) noexcept;
...
template <> struct hash<::mmscenegraph::NodeId> {
  ::std::size_t operator()(const ::mmscenegraph::NodeId &self) const noexcept {
    return ::mmscenegraph::mmscenegraph$cxxbridge1$NodeId$operator$hash(self);
  }
};

template <> struct hash<::mmscenegraph::AttrId> {
  ::std::size_t operator()(const ::mmscenegraph::AttrId &self) const noexcept {
...
template <> struct hash<::mmscenegraph::Translate2DAttrIds> {
  ::std::size_t operator()(const ::mmscenegraph::Translate2DAttrIds &self) const noexcept {
...
template <> struct hash<::mmscenegraph::Translate3DAttrIds> {
  ::std::size_t operator()(const ::mmscenegraph::Translate3DAttrIds &self) const noexcept {
...
template <> struct hash<::mmscenegraph::Rotate3DAttrIds> {
  ::std::size_t operator()(const ::mmscenegraph::Rotate3DAttrIds &self) const noexcept {
...
template <> struct hash<::mmscenegraph::Scale3DAttrIds> {
  ::std::size_t operator()(const ::mmscenegraph::Scale3DAttrIds &self) const noexcept {
...
template <> struct hash<::mmscenegraph::CameraAttrIds> {
  ::std::size_t operator()(const ::mmscenegraph::CameraAttrIds &self) const noexcept {
...
template <> struct hash<::mmscenegraph::MarkerAttrIds> {
  ::std::size_t operator()(const ::mmscenegraph::MarkerAttrIds &self) const noexcept {
...
MMSCENEGRAPH_API_EXPORT void ShimFlatScene::evaluate(const ::mmscenegraph::ShimAttrDataBlock &attrdb, ::rust::Slice<const ::std::uint32_t> frame_list) noexcept {
...
MMSCENEGRAPH_API_EXPORT void ShimEvaluationObjects::add_bundle(const ::mmscenegraph::BundleNode &bnd_node) noexcept {
  mmscenegraph$cxxbridge1$ShimEvaluationObjects$add_bundle(*this, bnd_node);
}

MMSCENEGRAPH_API_EXPORT void ShimEvaluationObjects::add_camera(const ::mmscenegraph::CameraNode &cam_node) noexcept {
  mmscenegraph$cxxbridge1$ShimEvaluationObjects$add_camera(*this, cam_node);
}

MMSCENEGRAPH_API_EXPORT void ShimEvaluationObjects::add_marker(const ::mmscenegraph::MarkerNode &mkr_node) noexcept {
