...
# @unittest.skip
class TestCameraSolveHcwPainting(test_api_utils.APITestCase):
    def create_scene_hcw_painting(self, frame_a, frame_b):
        ...
        marker_file_path = self.get_data_path('uvtrack', 'hcw_painting.uv')
    ...
    def test_camera_solve6_hcw_painting(self):
        frame_a = 0
        frame_b = 227
        scene_scale = 10.0
        ...
        scene_data = self.create_scene_hcw_painting(frame_a, frame_b)

        name = 'solver_camera_solve6_hcw_painting'
        self.solve_hcw_painting(
            name,
            scene_data['cam'],
            scene_data['lens'],
            scene_data['mkr_list'],
