...
class TestSolver11(solverUtils.SolverTestCase):
    ...
    def do_solve(self, solver_name, solver_index, scene_graph_mode):
        ...
        # save the output
        path = self.get_data_path('solver_test11_%s_before.ma' % solver_name)
        ...
        # save the output
        file_name = 'solver_test11_{}_{}_after.ma'.format(
    ...
    def test_init_ceres_maya_dag(self):
        self.do_solve('ceres', 3, mmapi.SCENE_GRAPH_MODE_MAYA_DAG)

    def test_init_ceres_mmscenegraph(self):
        self.do_solve('ceres', 3, mmapi.SCENE_GRAPH_MODE_MM_SCENE_GRAPH)
